...
export const BASS_NOTES = ['C2', 'D2', 'E2', 'F2', 'G2', 'A2', 'C3', 'D3'] as const;
export const LEAD_NOTES = ['C4', 'D4', 'E4', 'G4', 'A4', 'C5', 'D5', 'E5'] as const;

export function freqOf(note: string): number {
