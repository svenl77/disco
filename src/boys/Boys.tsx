...
function Boy(props: { boy: (typeof BOYS)[number]; idx: number }) {
  ...
  return (
    <div
      class={`boy ${sizeClass()} ${isCenter() ? 'center' : ''}`}
      data-dance={props.boy.dance}
      data-id={props.boy.id}
      style={{ '--boy-color': props.boy.color }}
      onClick={onClick}
      role="button"
 ...
 */
function PlaceholderBoy(props: { color: string; accent: string }) {
  return (
    <svg viewBox="0 0 200 240" xmlns="http://www.w3.org/2000/svg">
      {/* Stem */}
      <path
        d="M68,42 Q82,10 100,24 Q118,10 132,42 Q148,24 144,56 Q132,64 116,56 Q100,66 84,56 Q68,64 56,56 Q52,24 68,42 Z"
        fill="#3aa84a"
        stroke="#1d6128"
        stroke-width="3"
      />
